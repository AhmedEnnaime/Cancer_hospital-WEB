...
?>
    <div class="popup popup--icon -success js_success-popup popup--visible">
      ...
      <div class="popup__content">
        ...
        <p>Rendez-vous supprimé avec succès</p>
        <p>
...
<li class="breadcrumb-item"><a href="view-appointments-approved.php">Rendez-vous Approuver </a>
</li>
</ul>
</div>
</div>
...
<tbody>
<?php
        $sql ="SELECT * FROM appointment WHERE status='Approuver'  and delete_status = '0'";
        ...
        while($rs = mysqli_fetch_array($qsql))
        {
          ...
          else
          {
            ...
            echo "<a href='appreport.php?patientid=$rs[patientid]&appointmentid=$rs[appointmentid]' class='btn btn-xs btn-primary'>Voir le Rapport</a>";
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
     <?php echo "<script>setTimeout(\"location.href = 'view-appointments-approved.php';\",1500);</script>"; ?>
    </p>
  </div>
</div>
